  ...
  <div>
    ...
    <b-card hidden style="margin-bottom: 50px" class="b-ver  threec" id="mellicard">
      ...
      <b-card style="text-align:center" v-if="!acceptv">
        ...
        <b-form-group label=" "><br><br><br>
          ...
          <a href="javascript:void(0)" @click="submitaccept()" class=" btn btn-dark" style="margin:20px"> ارسال برگ پذیرش
            مقررات</a>
    ...
    <b-card hidden style="margin-bottom: 50px" class="b-ver twoc" id="mobilecard">
      ...
      <b-form-group v-if="!mobilev" label=" "><br><br>
        ...
        <a hidden @click="mobileverify()" href="javascript:void(0)" class="small btn btn-success" id="mcb">تایید شماره
          همراه</a>
      ...
      <b-form-group v-if="!emailv" label="">
        ...
        <a hidden @click="emailverify()" href="javascript:void(0)" id="ecb" class="small btn btn-success">تایید آدرس ایمیل
        </a>
