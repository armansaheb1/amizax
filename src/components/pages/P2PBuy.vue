        ...
        <div class="">
            <div style="width: 100%; float: left" class="">
                ...
                <div class="card navdark" style=";margin-bottom: -3px">
                    <div>
                        <table class="navdark notphone" style="direction: rtl; margin-bottom: 0;width: 100%">
                            ...
                            <tbody>
                                <tr v-for="item in orders" class="smalltext lightertext" v-bind:key="item"
                                    ...
                                    <td style="font-size: 8px;"><img class=""
                                            ...
                                            style="height: 30px" alt=""><br> {{ item.currency_name }}<br>
                                        {{ item.get_user }}
                                    </td>

                                    <td>{{ item.price }}</td>
                                    <td>{{ item.chain }}</td>
                                    <td>{{ item.balance - item.done }}</td>
                                    ...
                                    <td v-if="notphone" style="width: 20%">
                                        <a :href="'/p2p/buypagenew/' + item.rid"
                                            style="padding-top: 2px; padding-bottom: 2px; margin: 3px auto; width:80%; "
                                            class="btn buttonblue">خرید</a>
                                        <button @click="$store.state.chatting = item.get_user; $store.state.chatside = true"
                                            style="padding-top: 2px; padding-bottom: 2px; margin: 3px auto; width:80%; "
                                            class="btn btn-info">پیام</button>
                                    </td>
                                </tr>
                        ...
                        <table v-for="item in orders" class="navdark onphone"
                            style="direction: rtl; margin-bottom: 0;width: 100%">
                            <thead class="card-header">
                                <tr class="smalltext normaltext " style=";border-bottom: rgba(100,100,100, 0.5)">
                                    <th> ارز</th>
                                    <th style="width: 15%">قیمت</th>
                            ...
                            <tbody>
                                ...
                                <tr v-if="!notphone" style="font-size: 10px;border-bottom: transparent;">
                                    <td colspan="8" style="width: 100%; padding: 5%;"> <a
                                            :href="'/p2p/buypagenew/' + item.rid"
                                            style="margin: 0 20px; padding: 2px 45px; " class="btn  buttonblue">خرید</a>
                                        <button @click="$store.state.chatting = item.get_user; $store.state.chatside = true"
                                            style="margin: 5px 0; padding: 2px 45px; " class="btn  btn-info">پیام</button>
                                    </td>
                                </tr>
