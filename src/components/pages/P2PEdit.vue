    ...
    <div style="padding: 2%">
        ...
        " alt=""><br>{{ key.replace('USDT', '') }} </button>
                    ...
                    <form v-if="process == 1" @submit.prevent="process = 1" style="text-align: center;">
                        ...
                        <div style="width: 90%; margin : auto; ">
                            <button disabled class="normaltext alert alert-secondary form-control"
                                ...
                                <div v-if="price_type === 'custom'">
                                    ...
                                    <br>
                                    <label> قیمت پیشنهادی شما درصد از قیمت جهانی بالاتر است</label>
                                </div>
                            </button>
                        ...
                        <p style="text-align: right;float: right;font-size: 12px ; width: 75%;">با تعیین محدودیت، اگر قیمت
                            جهانی ارز از
                            میزان حداقل یا
    ...
    methods: {
        ...
        async get_request() {
            await axios
                ...
                .then(response => response.data)
                .then(response => {
                    this.currency = response.currency_name
                    this.price = response.price
                    this.balance = response.balance
                    this.minimum_amount = response.minimum_amount
                    this.maximum_time = response.maximum_time
        ...
        async submit() {
            await axios
                .put(`/p2prequests/${this.$route.params.id}`, {
