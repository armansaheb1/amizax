        ...
        <div class="onphone" v-if="!notphone">
            ...
            <div class="card navdark" v-if="price && sym">
                <div class="card-body">
                    ...
                    <h4 style="float:right; color:rgba(150,150,150, .8)" v-if="price && this.sym !== 'USDT'">قیمت دلاری : <a
                            style="font:20px ; font-family: 'UD'!important; text-decoration: none;" class=" lightertext">{{
                    ...
                    <fieldset class="demo-vertical-spacing-sm">
                        <form @submit.prevent="submit()">
                            ...
                            <div class="list navdark" v-if="!hidelist">
                                <input @input="search()" type="text" class="form-control navdark" v-if="!hidelist"
                                ...
                                <div style="width: 80%;margin: auto;height:165px; overflow-x:hidden ;overflow-y:scroll ; border: solid rgba(150,150,150, .8) !important .2px ; border-radius: 0 0 5px 5px; font-size: 13px!important"
                                    id="my-list-id">
                                    <button id="USDT" v-if="'USDT'.includes(searchtxt.toUpperCase())" class=" curbtn"
                                        ...
                                        style="height:55px; width: 100% ; background: none ;border-style: none; border-bottom: solid .2px rgba(150,150,150, .8) !important ;border-shadow:none margin:0 ; font: 13px 'UD'!important"
                                        ...
                                        <div class="input-group mb-3" style="direction:ltr ; margin:0">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text buttonblue"
                                                    style="border-radius: 5px 0 0 5px;" id="basic-addon1">ریال</span>
                                            </div>
                    ...
                    <fieldset class="demo-vertical-spacing-sm">
                        ...
                        <form @submit.prevent="submit()">
                            ...
                            <button type="button" @click="listshow()" style="margin: 6px" v-if="sym"
                                ...
                                ارز</button>
                            <br><br>
                            <div class=" navdark" v-if="!hidelist">
                                <input @input="search()" type="text" class="form-control navdark " v-if="!hidelist"
                                    placeholder="search ..." v-model="searchtxt"
                                    style="width: 80%;margin: auto;border-radius: 5px 5px 0 0; border-color:#rgba(150,150,150, .8) !important; border: 0.2px solid rgba(150, 150, 150, 0.8) !important;">
                                <div style="width: 80%;margin: auto;height:165px; overflow-x:hidden ;overflow-y:scroll ; border: solid rgba(150,150,150, .8) !important .2px ; border-radius: 0 0 5px 5px; font-size: 13px!important;"
                                    id="my-list-id">
                                    <button id="USDT" v-if="'USDT'.includes(searchtxt.toUpperCase())" class=" curbtn"
                                        onMouseOver="this.style.background='rgba(150, 150, 150, 0.4)'"
                            ...
                            <div v-if="sym">
                                ...
                                <div style="width: 80%; margin-right:10%; float: right;">
                                    <a style=";font-size:10px; float: right">حداقل میزان خرید ۱۰۰۰,۰۰۰ ریال
                                        میباشد</a><br>
                                    <p style="font-size: 15px;float:right; color:rgba(150,150,150, .8)" v-if="price">دریافتی
                                        : <a style="font:16px 'UD'; padding:5px 20px ">{{ getting.toFixed(4) }}</a></p>
                                </div>
                                <div style="clear: both;"></div>
...
export default {
    ...
    methods: {
        ...
        async submit() {
            ...
            var price = parseFloat(this.price.rial) * this.userfee
            var uprice = parseFloat(this.price.rial) * this.userfee
            if (this.sym === 'USDT') {
