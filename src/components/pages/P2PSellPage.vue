    ...
    <div style="padding: 2%">
        ...
        <div class="card navdark" v-if="currentStep === 0">
            ...
            <div class="card-body" style="padding: 3%;">
                ...
                <button @click="accept()" style="margin: 20px; min-width: 25%" class="btn buttonblue">تایید</button>
            </div>
        </div>
        ...
        <div class="card navdark" v-if="currentStep === 1">
            ...
            <div class="card-body" style="padding: 3%;">
                <div style="width: 30% ; margin: auto">
                    <div class="alert bg lightertext">
                        ‌ در انتظار پرداخت امن
                    </div>
                </div><br><br>
                <p class="lightertext" style="text-align: justify;direction: rtl;">به خریدار اعلام شد که پرداخت امن را انجام
                    دهد و اگر در زمان مقرر انجام ندهد درخواست لغو خواهد شد.</p>
                <br><br>
                <p class="lightertext" style="text-align: justify;direction: rtl;">برای جلوگیری از جریمه شدن پس از پرداخت
                    امن در زمان مقرر ارز دیجیتال را انتقال دهید.</p>
                <br><br>
        ...
        <div class="card navdark" v-if="currentStep === 2">
            ...
            <div class="card-body" style="padding: 3%;">
                ...
                <p class="lightertext" style="text-align: justify;direction: rtl;">
                    پرداخت امن توسط خریدار انجام شده.لطفا در زمان مقرر ارز دیچیتال را به آدرس های زیر منتقل کنید..</p>
                <br><br>
                <table style="width :100%;margin: auto; direction: rtl">
                    ...
                    <tbody class="bg2">
                        <tr>
                            ...
                            <td style="padding: 10px;width: 50%; text-align: left;">{{ brequest.details }}
                            </td>
                        </tr>
                    </tbody>
                </table><br><br>
                ...
                <p class="lightertext" style="text-align: justify;direction: rtl;">
                    پس از انجام انتقال با دکمه تایید به خریدار اطلاع دهید</p>

                <button @click="$store.state.chatting = brequest.get_user2; $store.state.chatside = true"
                    style="margin: 20px; min-width: 25%" class="btn btn-warning">پیام</button>
                <button @click="cancel()" style="margin: 20px; min-width: 25%" class="btn btn-danger">لغو</button>
                <button @click="sent()" style="margin: 20px; min-width: 25%" class="btn buttonblue">تایید</button>
            </div>
        </div>
        ...
        <div class="card navdark" v-if="currentStep === 3">
            ...
            <div class="card-body" style="padding: 3%;">
                ...
                <p class="lightertext" style="text-align: justify;direction: rtl;">خریدار در حال بررسی انتقال شماست و پس از
                    تایید ایشان وجه پرداختی به کیف شما اضافه خواهد شد.</p>
                <br><br>
...
export default {
    ...
    methods: {
        ...
        async accept() {
            if (this.$route.params.id) {
                await axios
                    .post(`/p2pbuyaccept/${this.$route.params.id}`)
                    .then(response => response.data)
                    .then(response => {
                        this.request = response.get_request
                        this.brequest = response
        ...
        async sent() {
            if (this.$route.params.id) {
                await axios
                    .post(`/p2psent/${this.$route.params.id}`)
                    .then(response => response.data)
                    .then(response => {
                        this.request = response.get_request
                        this.brequest = response
