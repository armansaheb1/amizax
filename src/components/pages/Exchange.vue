<template>
    <div>
        ...
        <div class="card navdark" v-if="sym && sym2 && price && price2">
            ...
            <div class="card-body">
                <h3 v-if="sym && sym2 && price && price2" style="float:right; color:#888; width: 100%; text-align: right"> :
                    قیمت نسبی ارز ها<a style="font:20px ; font-family: 'UD'!important; text-decoration: none; float: left"
                        class=" lightertext">{{
                            ...
                            <b-form-group label="">
                                ...
                                <div style="width: 80%; margin:auto; padding: 1%" class="card navdark">
                                    ...
                                    <div class="input-group mb-3" style="direction:ltr ; margin:0">
                                        ...
                                        <input class="form-control navdark" autocomplete="off" step="any" required
